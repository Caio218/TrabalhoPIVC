...
import utils.transformacoes as tfm
...
def limiarizar(imagem):
    print('Realizando limiarização... \n|######...............|')
    print('|###########..........|')

    # Recebe imagem e transforma em matriz
    matriz_colorida = tfm.imagem_to_matriz(imagem)

    # Transforma imagem em tons de cinza
    matriz_cinza = tfm.imagem_to_cinza(matriz_colorida)
    ...
    plt.savefig(os.path.join('resultado_preto_branco', img_limiarizada))
    print('|#####################|')
    print('Limiarização realizada! \nImagem salva na pasta: "resultado_preto_branco"')
